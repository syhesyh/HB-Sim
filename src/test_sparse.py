...
Hardware_config_PIM = {
    "device": DeviceType.HB_Sparse_PIM,
    "n_device": 2,
    "GPU": make_gpu_config(2, hbf_en=True),
    "PIM": make_pim_config(num_pim_device=2, num_pim_stack=4, sparse_enable=True),
}

# Host_request_batch = infra.Request_Batch(0.05, Model)
# for i in range(32):
#     Host_request_batch.append(i, 4096, 4096+256+128)
...
#     hbf_track_table=Host_hbf_track_table, warmup_iteration=256, scheduling_interval=4, scheduling_enable=False)
